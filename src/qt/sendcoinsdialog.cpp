    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Global-Currency-Reserve address (e.g. B8gZqgY4r2RoEdqYk3QsAqFckyf9pRHN6i)"));
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, rcp.amount), Qt::escape(rcp.label), rcp.address));
		...
		{ 
#if QT_VERSION < 0x050000 
        formatted.append(tr("<b>%1</b> in %4 blocks of %5 Global-Currency-Reserve each to %2 (%3)?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, rcp.amount),  
			Qt::escape(rcp.label),  
			rcp.address,  
